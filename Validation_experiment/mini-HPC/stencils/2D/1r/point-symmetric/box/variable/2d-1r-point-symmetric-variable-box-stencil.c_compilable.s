	.file	"2d-1r-point-symmetric-variable-box-stencil.c_compilable.c"
	.text
...
.L23:
	...
	vmovsd	(%rsi,%rdx), %xmm2
	addq	$40, %rcx
	vmulsd	8(%rsi,%rdx), %xmm3, %xmm0
	vaddsd	16(%rsi,%rdx), %xmm2, %xmm2
	vmulsd	8(%rcx), %xmm2, %xmm2
	vmovsd	(%r8,%rdx), %xmm1
	vaddsd	16(%rdi,%rdx), %xmm1, %xmm1
	vmulsd	24(%rcx), %xmm1, %xmm1
	vaddsd	%xmm0, %xmm2, %xmm3
	vmovsd	8(%r8,%rdx), %xmm2
	vmovsd	(%rdi,%rdx), %xmm0
	vaddsd	8(%rdi,%rdx), %xmm2, %xmm2
