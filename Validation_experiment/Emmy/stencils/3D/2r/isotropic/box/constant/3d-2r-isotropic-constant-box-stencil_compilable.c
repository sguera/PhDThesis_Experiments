...
void dummy(double *);
extern void kernel_loop(double *a, double *b, double c0, double c1, double c2, double c3, double c4, double c5, double c6, int M, int N, int P);
int main(int argc, char **argv)
{
  ...
  double c0;
  c0 = (rand() / ((double ) RAND_MAX)) / 9.0;
  double c1;
  c1 = (rand() / ((double ) RAND_MAX)) / 9.0;
  double c2;
  c2 = (rand() / ((double ) RAND_MAX)) / 9.0;
  double c3;
  c3 = (rand() / ((double ) RAND_MAX)) / 9.0;
  double c4;
  c4 = (rand() / ((double ) RAND_MAX)) / 9.0;
  double c5;
  c5 = (rand() / ((double ) RAND_MAX)) / 9.0;
  double c6;
  c6 = (rand() / ((double ) RAND_MAX)) / 9.0;
  int repeat = 1;
  double runtime = 0.0;
  double wct_start;
  double wct_end;
  ...
  while ((runtime < 2.0) || (repeat <= 2))
  {
    ...
    {
      kernel_loop(a, b, c0, c1, c2, c3, c4, c5, c6, M, N, P);
      tmp = a;
      a = b;
      b = tmp;
    }
